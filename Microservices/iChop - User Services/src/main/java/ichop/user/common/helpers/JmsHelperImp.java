...
import ichop.user.common.domain.BaseReplyModel;
import ichop.user.common.domain.BaseRequestModel;
import ichop.user.common.domain.ErrorReplyModel;
...
import static ichop.user.common.constants.JmsLoggingConstants.*;
