...
@Component
public class PasswordTokenListenerImp implements PasswordTokenListener {
    ...
    @Autowired
    public PasswordTokenListenerImp(JmsHelper jmsHelper, ObjectMapper objectMapper, PasswordTokenServices passwordTokenServices) {
