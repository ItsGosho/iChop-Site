package ichop.webstorage;

import com.fasterxml.jackson.databind.ObjectMapper;
import ichop.webstorage.components.JmsServices;
import ichop.webstorage.listeners.UserDataListener;
...
public class CLR implements CommandLineRunner {
    ...
    @Autowired
    public CLR(UserDataListener userDataListener, JmsServices jmsServices, ObjectMapper objectMapper) {
