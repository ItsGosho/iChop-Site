...
public class UserServicesImp implements UserServices {
    ...
    private static final String RESET_PASSWORD_PREFIX = "http://localhost:8000/users/reset/password?token=";
    ...
    public void sendPasswordResetEmail(UserForgottenPasswordBindingModel userForgottenPasswordBindingModel) {
        ...
        String message = "<small>You have 24h to reset your password: " + RESET_PASSWORD_PREFIX + passwordResetToken.getToken() + "</small>";
