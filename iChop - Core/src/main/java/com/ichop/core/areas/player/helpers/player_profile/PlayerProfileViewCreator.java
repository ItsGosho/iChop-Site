...
public class PlayerProfileViewCreator extends BaseViewCreator {
    ...
    @Autowired
    protected PlayerProfileViewCreator(ModelMapper modelMapper, PlayerBasicStatisticJmsServices playerBasicStatisticJmsServices, PlayerLinkJmsServices playerLinkJmsServices, ObjectMapper objectMapper) {
        super(modelMapper);
